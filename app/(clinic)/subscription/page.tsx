  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="bg-white p-12 rounded-xl border border-[var(--border)] shadow-sm text-center flex flex-col items-center justify-center">
        ...
        <p className="text-lg text-muted-foreground max-w-md mb-5">
        ...
        <a 
          ...
          className="inline-flex items-center gap-2.5 bg-[#25D366] text-white px-8 py-3.5 rounded-full font-bold text-lg hover:bg-[#20bd5a] transition-all shadow-md active:scale-95"
        >
        ...
        <div className="mt-10 bg-[var(--accent)]/5 border border-[var(--accent)]/20 rounded-2xl p-8 text-center shadow-sm w-full max-w-lg">
